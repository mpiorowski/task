...
{#if loading}
	<div class="absolute left-0 top-0 flex h-full w-full items-center justify-center bg-gray-900">
		<svg
...
{#each data.recommended.data as recommendation, i}
	<div class="mb-4 grid grid-cols-2 rounded border border-gray-800" id={`anime-${i}`}>
